...
\renewcommand{\DocumentShortTitle}{[Kurztitel]}
\renewcommand{\DocumentFooterLabel}{[Modul]}
...
% --------------------- Hauptteil --------------------
    ...
    \input{texte/01_einleitung}
    \input{texte/02_technischer_ist_zustand}
    \input{texte/03_analyse_und_reverse_engineering}
    \input{texte/04_fehleranalyse_und_instandssetzung}
    \input{texte/05_entwicklung_der_steuerung}
    \input{texte/06_gesamtsystem_und_inbetriebnahme}
    \input{texte/07_funktionsprüfung_und_ergebnisse}
    \input{texte/08_projektverlauf}
